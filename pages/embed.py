...
if files:
    current_set = set([file.name for file in files])
    ...
    if len(deleted) > 0:
        deleted = [files_dict[file] for file in deleted]
        utils.delete_pdfs(deleted, False, namespace, pinecone_api_key, pinecone_env, "test")
